...
public class LocalMapVisualizer extends JComponent implements Runnable {
    ...
    private void drawTreeNode(meta.Node parent, meta.Node node) {
        ...
        nodes.add(par);
        nodes.add(nod);
        if(parent.getType().equals("w")&&!node.getType().equals("Immovable")) {
